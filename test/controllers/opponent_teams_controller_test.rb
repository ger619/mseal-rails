...
class OpponentTeamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opponent_team" do
    assert_difference("OpponentTeam.count") do
      post opponent_teams_url, params: { opponent_team: { name: @opponent_team.name, team_url: @opponent_team.team_url } }
    end
  ...
  test "should update opponent_team" do
    patch opponent_team_url(@opponent_team), params: { opponent_team: { name: @opponent_team.name, team_url: @opponent_team.team_url } }
